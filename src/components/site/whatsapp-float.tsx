    ...
    <AnimatePresence>
      {visible ? (
        <motion.a
          ...
          className="group fixed bottom-5 right-5 z-40 md:bottom-8 md:right-8"
        >
          <span className="relative flex size-14 items-center justify-center rounded-full bg-[#25d366] text-white shadow-2xl shadow-black/50 transition-transform duration-200 group-hover:scale-110">
            <span
              aria-hidden
